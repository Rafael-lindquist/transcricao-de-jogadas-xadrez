...
def contorno_tabuleiro(pts, frame):
    ...
    cv.line(frame, pt2, pt4, color=(0, 0, 255), thickness=3)
    cv.line(frame, pt4, pt3, color=(0, 0, 255), thickness=3)
    cv.line(frame, pt3, pt1, color=(0, 0, 255), thickness=3)
...
def casas_tabuleiro(v: List[Tuple[int, int]], casas, nome_casas):
    """
